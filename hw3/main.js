...
class Cart extends GoodsList {
    removeFromCart(goodId) {makeGetRequest(`${API_URL}//deleteFromBasket.json`, (goods) => {
            this.goodId = JSON.parse(goods);
            callback();
    ...
    updateCartItem(goodId, goods) {makeGetRequest(`${API_URL}///getBasket.json`, (goods) => {
            this.goodId = JSON.parse(goods);
            callback();
